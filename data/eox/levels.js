let levels = {
  ...
  Shogun: {
    ...
    hawkSlice: {
      ...
      // Damage: ["140%", "144%", "148%", "168%", "172%", "176%", "180%", "225%"],
      Damage: ["120%", "123%", "126%", "155%", "158%", "161%", "164%", "225%"],
      "Adjacent Damage": ["x1.75", "x1.75", "x1.75", "x1.75", "x1.75", "x1.75", "x1.75", "x1.75"]
    },
    gnashingFang: {
    ...
    soaringTempest: {
      "TP": ["12", "12", "12", "16", "16", "16", "16", "23"],
      Speed: ["80%", "80%", "80%", "80%", "80%", "80%", "80%", "80%"],
      Accuracy: ["-5%", "-5%", "-5%", "-5%", "-5%", "-5%", "-5%", "-5%"],
      Damage: ["100%", "103%", "106%", "120%", "123%", "126%", "129%", "150%"],
      "Force Restore": ["+1%", "+1%", "+1%", "+2%", "+2%", "+2%", "+2%", "+3%"]
    },
    bloodyLance: {
    ...
    savageClaw: {
      //"TP Recovered": ["1", "2", "3", "5", "6", "7", "8", "10"],
      // "Static TP Restore": ["1", "1", "1", "2", "2", "2", "2", "2"],
      // "Percent TP Restore": ["0%", "0%", "0%", "0%", "0%", "0%", "0%", "1%"],
      "Chance": ["17%", "18%", "19%", "21%", "23%", "25%", "27%", "34%"]
    },
    soleFocus: {
    ...
    blitzCommand: {
      ...
      Damage: ["75%", "78%", "81%", "93%", "96%", "99%", "102%", "120%"]
    },
    galvanize: {
    ...
    blazeSpirit: {
      ...
      // "Damage Taken": ["90%", "85%", "80%", "75%", "60%", "60%"],
    ...
    greatGeneral: {
      ...
      "Damage Dealt": ["20%", "25%", "30%", "35%", "40%", "45%"],
